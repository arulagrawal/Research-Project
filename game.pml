...
proctype a() {
    ...
    if :: (a_loaded == false) -> {
        if :: (a_moves[index] == -1) -> {
            ...
            :: (a_y >= 1 && a_moves[index-3] != 3) -> {
                a_moves[index] = 1;
            }
            :: (a_y <= n-2 && a_moves[index+3] != 1) -> {
                a_moves[index] = 3;
            }
            fi
    ...
    :: else -> {
        if :: (a_moves_loaded[index] == -1) -> {
            ...
            :: (a_y >= 1 &&  a_moves_loaded[index-3] != 3) -> {
                a_moves_loaded[index] = 1;
            }
            :: (a_y <= n-2 &&  a_moves_loaded[index+3] != 1) -> {
...
proctype b() {
    ...
    if :: (b_loaded == false) -> {
        if :: (b_moves[index] == -1) -> {
            ...
            :: (b_y >= 1 && b_moves[index-3] != 3) -> {
                b_moves[index] = 1;
            }
            :: (b_y <= n-2 && b_moves[index+3] != 1) -> {
                b_moves[index] = 3;
            }
            fi
    ...
    :: else -> {
        if :: (b_moves_loaded[index] == -1) -> {
            ...
            :: (b_y >= 1 &&  b_moves_loaded[index-3] != 3) -> {
                b_moves_loaded[index] = 1;
            }
            :: (b_y <= n-2 &&  b_moves_loaded[index+3] != 1) -> {
